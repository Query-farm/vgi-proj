        ...
        tags = {
            **object_tags(
                ...
                doc_md=(
                    ...
                    "```\n\n"
                    "It can also be applied per row over a coordinate column, reading `.x` "
                    "or `.y` off the returned struct.\n\n"
                    "### Notes\n\n"
    ...
    class Meta:
        ...
        tags = object_tags(
            ...
            doc_md=(
                ...
                "```\n\n"
                "It can also be applied per row over a lon/lat column, reading `.x` or "
                "`.y` off the returned struct.\n\n"
                "### Notes\n\n"
    ...
    class Meta:
        ...
        tags = object_tags(
            ...
            doc_md=(
                ...
                "```\n\n"
                "It can also be applied per row over an easting/northing column, reading "
                "`.lon` or `.lat` off the returned struct.\n\n"
                "### Notes\n\n"
    ...
    class Meta:
        ...
        tags = object_tags(
            ...
            doc_md=(
                ...
                "```\n\n"
                "It is often used in a predicate over a table of points -- for example to "
                "keep only rows within a given number of metres of a reference "
                "location.\n\n"
                "### Notes\n\n"
    ...
    class Meta:
        ...
        tags = object_tags(
            ...
            doc_md=(
                ...
                "```\n\n"
                "It can also be applied per row over origin/destination columns to derive "
                "a heading for each leg of a route.\n\n"
                "### Notes\n\n"
